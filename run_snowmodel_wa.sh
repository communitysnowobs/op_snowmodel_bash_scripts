...
#This script will execute the complete assimilative snowmodel run for the NE WA
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wa_domain/swed_wi_assim/
#let's move it to /scratch and get it off of depot
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wa_domain/snod_wi_assim/
#let's move it to /scratch and get it off of depot
