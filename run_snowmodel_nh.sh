...
################################
#kick of snow model run for nh domain
cd /nfs/depot/cce_u1/hill/dfh/op_snowmodel/nh_snowmodel/
./snowmodel

################################
# tons of file management coming your way...
smpath="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/nh_snowmodel/"
outpath="/scratch/op_snowmodel_outputs/NH/"
...
gdal_translate -of GTiff -a_srs EPSG:32619 -a_ullr 278745 4912005 339765 4862895 $fin $fout
#clean up
rm "${fin}"
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/nh_domain/swed_wo_assim/
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/nh_domain/snod_wo_assim/
