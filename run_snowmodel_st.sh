...
#This script will execute the complete assimilative snowmodel run for the Sawtooth (ID)
...
outpath="/scratch/op_snowmodel_outputs/ST/"
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/st_domain/swed_wo_assim/
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/st_domain/swed_wi_assim/
#let's move it to /scratch and get it off of depot
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/st_domain/snod_wo_assim/
#let's move it to /scratch and get it off of depot
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/st_domain/snod_wi_assim/
#let's move it to /scratch and get it off of depot
