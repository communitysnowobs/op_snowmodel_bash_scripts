#! /bin/bash
#to backfill WY domain for ca 2021...this and backfill2.sh will allow you to convert
...
/scratch/cdo/bin/cdo settaxis,$year-10-01,00:00:00,1days /nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/swed_ca2021.nc /nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/swed_ca2021_2.nc 
...
infile="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/swed_ca2021_2.nc"
outfile="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/swed_ca2021_3.nc"
...
do
  ...
  stamp="${y}_${m}_${d}"
  echo "$stamp"
  singleday="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/$stamp.nc"
...
fin="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/$stamp.nc"
fout="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/$stamp.tif"
...
fin="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/$stamp.tif"
fout="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/${stamp}_mask.tif"
python /nfs/attic/dfh/miniconda/envs/cso/bin/gdal_calc.py -A $fin --outfile=$fout --calc="A*(A>0)" --NoDataValue=0
conda deactivate  
rm -f $fin

#cloud optimized geotiff...
fin="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/${stamp}_mask.tif"
fout="/nfs/depot/cce_u1/hill/dfh/op_snowmodel/ca_snowmodel/ctl_files/wo_assim/WY2021/${stamp}_mask_cog.tif"
