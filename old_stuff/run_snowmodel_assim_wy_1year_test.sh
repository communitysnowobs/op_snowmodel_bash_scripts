...
outpath="/scratch/op_snowmodel_outputs/WY_ASSIM/"
...
rm -f $fin
gsutil cp $fout gs://cso_test_upload/wy_assim_test/swed_wo_assim/
...
gdal_translate $fin $fout -co TILED=YES -co COPY_SRC_OVERVIEWS=YES -co COMPRESS=DEFLATE
rm -f $fin
gsutil cp $fout gs://cso_test_upload/wy_assim_test/snod_wo_assim/
#let's move it to /scratch and get it off of depot
...
gdal_translate $fin $fout -co TILED=YES -co COPY_SRC_OVERVIEWS=YES -co COMPRESS=DEFLATE
rm -f $fin
gsutil cp $fout gs://cso_test_upload/wy_assim_test/swed_wi_assim/
#let's move it to /scratch and get it off of depot
...
gdal_translate $fin $fout -co TILED=YES -co COPY_SRC_OVERVIEWS=YES -co COMPRESS=DEFLATE
rm -f $fin
gsutil cp $fout gs://cso_test_upload/wy_assim_test/snod_wi_assim/
#let's move it to /scratch and get it off of depot
