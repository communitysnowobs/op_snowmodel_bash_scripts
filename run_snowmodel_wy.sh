...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wy_domain/swed_wo_assim/
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wy_domain/swed_wi_assim/
#let's move it to /scratch and get it off of depot
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wy_domain/snod_wo_assim/
#let's move it to /scratch and get it off of depot
...
mv $fout $fin
rm -f $fout
gsutil cp $fin gs://cso_test_upload/wy_domain/snod_wi_assim/
#let's move it to /scratch and get it off of depot
